...
set GENERATED_TYPE_BINDINGS="%~dp0Game\Source\StarterProject\Generated"
...
:Main
echo This script is intended to clean StarterProject generated files and therefore assumes its project structure.
