...
#include "SpatialTypeBinding_StarterProjectCharacter.h"
...
#include "StarterProjectCharacterSingleClientRepDataAddComponentOp.h"
#include "StarterProjectCharacterMultiClientRepDataAddComponentOp.h"
#include "StarterProjectCharacterHandoverDataAddComponentOp.h"

const FRepHandlePropertyMap& USpatialTypeBinding_StarterProjectCharacter::GetRepHandlePropertyMap() const
{
	return RepHandleToPropertyMap;
}

const FHandoverHandlePropertyMap& USpatialTypeBinding_StarterProjectCharacter::GetHandoverHandlePropertyMap() const
{
	return HandoverHandleToPropertyMap;
}

UClass* USpatialTypeBinding_StarterProjectCharacter::GetBoundClass() const
{
	return AStarterProjectCharacter::StaticClass();
}

void USpatialTypeBinding_StarterProjectCharacter::Init(USpatialInterop* InInterop, USpatialPackageMapClient* InPackageMap)
{
	Super::Init(InInterop, InPackageMap);

	RPCToSenderMap.Emplace("TestClientRPC", &USpatialTypeBinding_StarterProjectCharacter::TestClientRPC_SendRPC);
	RPCToSenderMap.Emplace("RootMotionDebugClientPrintOnScreen", &USpatialTypeBinding_StarterProjectCharacter::RootMotionDebugClientPrintOnScreen_SendRPC);
	RPCToSenderMap.Emplace("ClientVeryShortAdjustPosition", &USpatialTypeBinding_StarterProjectCharacter::ClientVeryShortAdjustPosition_SendRPC);
	RPCToSenderMap.Emplace("ClientCheatWalk", &USpatialTypeBinding_StarterProjectCharacter::ClientCheatWalk_SendRPC);
	RPCToSenderMap.Emplace("ClientCheatGhost", &USpatialTypeBinding_StarterProjectCharacter::ClientCheatGhost_SendRPC);
	RPCToSenderMap.Emplace("ClientCheatFly", &USpatialTypeBinding_StarterProjectCharacter::ClientCheatFly_SendRPC);
	RPCToSenderMap.Emplace("ClientAdjustRootMotionSourcePosition", &USpatialTypeBinding_StarterProjectCharacter::ClientAdjustRootMotionSourcePosition_SendRPC);
	RPCToSenderMap.Emplace("ClientAdjustRootMotionPosition", &USpatialTypeBinding_StarterProjectCharacter::ClientAdjustRootMotionPosition_SendRPC);
	RPCToSenderMap.Emplace("ClientAdjustPosition", &USpatialTypeBinding_StarterProjectCharacter::ClientAdjustPosition_SendRPC);
	RPCToSenderMap.Emplace("ClientAckGoodMove", &USpatialTypeBinding_StarterProjectCharacter::ClientAckGoodMove_SendRPC);
	RPCToSenderMap.Emplace("TestRPC", &USpatialTypeBinding_StarterProjectCharacter::TestRPC_SendRPC);
	RPCToSenderMap.Emplace("ServerMoveOld", &USpatialTypeBinding_StarterProjectCharacter::ServerMoveOld_SendRPC);
	RPCToSenderMap.Emplace("ServerMoveNoBase", &USpatialTypeBinding_StarterProjectCharacter::ServerMoveNoBase_SendRPC);
	RPCToSenderMap.Emplace("ServerMoveDualNoBase", &USpatialTypeBinding_StarterProjectCharacter::ServerMoveDualNoBase_SendRPC);
	RPCToSenderMap.Emplace("ServerMoveDualHybridRootMotion", &USpatialTypeBinding_StarterProjectCharacter::ServerMoveDualHybridRootMotion_SendRPC);
	RPCToSenderMap.Emplace("ServerMoveDual", &USpatialTypeBinding_StarterProjectCharacter::ServerMoveDual_SendRPC);
	RPCToSenderMap.Emplace("ServerMove", &USpatialTypeBinding_StarterProjectCharacter::ServerMove_SendRPC);
	RPCToSenderMap.Emplace("TestMulticast", &USpatialTypeBinding_StarterProjectCharacter::TestMulticast_SendRPC);

	UClass* Class = FindObject<UClass>(ANY_PACKAGE, TEXT("StarterProjectCharacter"));
...
void USpatialTypeBinding_StarterProjectCharacter::BindToView(bool bIsClient)
{
	...
	{
		ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterSingleClientRepData>([this](
			const worker::ComponentUpdateOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterSingleClientRepData>& Op)
		{
			// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
			if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterSingleClientRepData::ComponentId))
			{
				return;
			}
		...
		ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterMultiClientRepData>([this](
			const worker::ComponentUpdateOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterMultiClientRepData>& Op)
		{
			// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
			if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterMultiClientRepData::ComponentId))
			{
				return;
			}
			USpatialActorChannel* ActorChannel = Interop->GetActorChannelByEntityId(Op.EntityId);
		...
		if (!bIsClient)
		{
			ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterHandoverData>([this](
				const worker::ComponentUpdateOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterHandoverData>& Op)
			{
				// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
				if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterHandoverData::ComponentId))
				{
					return;
				}
				USpatialActorChannel* ActorChannel = Interop->GetActorChannelByEntityId(Op.EntityId);
	...
	ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterNetMulticastRPCs>([this](
		const worker::ComponentUpdateOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterNetMulticastRPCs>& Op)
	{
		// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
		if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterNetMulticastRPCs::ComponentId))
		{
			return;
		}
	...
	using ClientRPCCommandTypes = improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands;
	ViewCallbacks.Add(View->OnCommandRequest<ClientRPCCommandTypes::Testclientrpc>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::TestClientRPC_OnRPCPayload, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandRequest<ClientRPCCommandTypes::Rootmotiondebugclientprintonscreen>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::RootMotionDebugClientPrintOnScreen_OnRPCPayload, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandRequest<ClientRPCCommandTypes::Clientveryshortadjustposition>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ClientVeryShortAdjustPosition_OnRPCPayload, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandRequest<ClientRPCCommandTypes::Clientcheatwalk>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ClientCheatWalk_OnRPCPayload, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandRequest<ClientRPCCommandTypes::Clientcheatghost>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ClientCheatGhost_OnRPCPayload, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandRequest<ClientRPCCommandTypes::Clientcheatfly>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ClientCheatFly_OnRPCPayload, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandRequest<ClientRPCCommandTypes::Clientadjustrootmotionsourceposition>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ClientAdjustRootMotionSourcePosition_OnRPCPayload, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandRequest<ClientRPCCommandTypes::Clientadjustrootmotionposition>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ClientAdjustRootMotionPosition_OnRPCPayload, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandRequest<ClientRPCCommandTypes::Clientadjustposition>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ClientAdjustPosition_OnRPCPayload, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandRequest<ClientRPCCommandTypes::Clientackgoodmove>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ClientAckGoodMove_OnRPCPayload, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandResponse<ClientRPCCommandTypes::Testclientrpc>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::TestClientRPC_OnCommandResponse, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandResponse<ClientRPCCommandTypes::Rootmotiondebugclientprintonscreen>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::RootMotionDebugClientPrintOnScreen_OnCommandResponse, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandResponse<ClientRPCCommandTypes::Clientveryshortadjustposition>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ClientVeryShortAdjustPosition_OnCommandResponse, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandResponse<ClientRPCCommandTypes::Clientcheatwalk>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ClientCheatWalk_OnCommandResponse, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandResponse<ClientRPCCommandTypes::Clientcheatghost>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ClientCheatGhost_OnCommandResponse, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandResponse<ClientRPCCommandTypes::Clientcheatfly>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ClientCheatFly_OnCommandResponse, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandResponse<ClientRPCCommandTypes::Clientadjustrootmotionsourceposition>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ClientAdjustRootMotionSourcePosition_OnCommandResponse, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandResponse<ClientRPCCommandTypes::Clientadjustrootmotionposition>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ClientAdjustRootMotionPosition_OnCommandResponse, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandResponse<ClientRPCCommandTypes::Clientadjustposition>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ClientAdjustPosition_OnCommandResponse, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandResponse<ClientRPCCommandTypes::Clientackgoodmove>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ClientAckGoodMove_OnCommandResponse, this, std::placeholders::_1)));

	using ServerRPCCommandTypes = improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands;
	ViewCallbacks.Add(View->OnCommandRequest<ServerRPCCommandTypes::Testrpc>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::TestRPC_OnRPCPayload, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandRequest<ServerRPCCommandTypes::Servermoveold>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ServerMoveOld_OnRPCPayload, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandRequest<ServerRPCCommandTypes::Servermovenobase>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ServerMoveNoBase_OnRPCPayload, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandRequest<ServerRPCCommandTypes::Servermovedualnobase>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ServerMoveDualNoBase_OnRPCPayload, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandRequest<ServerRPCCommandTypes::Servermovedualhybridrootmotion>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ServerMoveDualHybridRootMotion_OnRPCPayload, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandRequest<ServerRPCCommandTypes::Servermovedual>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ServerMoveDual_OnRPCPayload, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandRequest<ServerRPCCommandTypes::Servermove>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ServerMove_OnRPCPayload, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandResponse<ServerRPCCommandTypes::Testrpc>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::TestRPC_OnCommandResponse, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandResponse<ServerRPCCommandTypes::Servermoveold>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ServerMoveOld_OnCommandResponse, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandResponse<ServerRPCCommandTypes::Servermovenobase>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ServerMoveNoBase_OnCommandResponse, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandResponse<ServerRPCCommandTypes::Servermovedualnobase>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ServerMoveDualNoBase_OnCommandResponse, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandResponse<ServerRPCCommandTypes::Servermovedualhybridrootmotion>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ServerMoveDualHybridRootMotion_OnCommandResponse, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandResponse<ServerRPCCommandTypes::Servermovedual>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ServerMoveDual_OnCommandResponse, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandResponse<ServerRPCCommandTypes::Servermove>(std::bind(&USpatialTypeBinding_StarterProjectCharacter::ServerMove_OnCommandResponse, this, std::placeholders::_1)));
}

void USpatialTypeBinding_StarterProjectCharacter::UnbindFromView()
{
	ViewCallbacks.Reset();
}

worker::Entity USpatialTypeBinding_StarterProjectCharacter::CreateActorEntity(const FString& ClientWorkerId, const FVector& Position, const FString& Metadata, const FPropertyChangeState& InitialChanges, USpatialActorChannel* Channel) const
{
	...
	improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterSingleClientRepData::Data SingleClientStarterProjectCharacterData;
	improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterSingleClientRepData::Update SingleClientStarterProjectCharacterUpdate;
	bool bSingleClientStarterProjectCharacterUpdateChanged = false;
	improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterMultiClientRepData::Data MultiClientStarterProjectCharacterData;
	improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterMultiClientRepData::Update MultiClientStarterProjectCharacterUpdate;
	bool bMultiClientStarterProjectCharacterUpdateChanged = false;
	improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterHandoverData::Data StarterProjectCharacterHandoverData;
	improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterHandoverData::Update StarterProjectCharacterHandoverDataUpdate;
	bool bStarterProjectCharacterHandoverDataUpdateChanged = false;

	BuildSpatialComponentUpdate(InitialChanges, Channel, SingleClientStarterProjectCharacterUpdate, bSingleClientStarterProjectCharacterUpdateChanged, MultiClientStarterProjectCharacterUpdate, bMultiClientStarterProjectCharacterUpdateChanged, StarterProjectCharacterHandoverDataUpdate, bStarterProjectCharacterHandoverDataUpdateChanged);
	SingleClientStarterProjectCharacterUpdate.ApplyTo(SingleClientStarterProjectCharacterData);
	MultiClientStarterProjectCharacterUpdate.ApplyTo(MultiClientStarterProjectCharacterData);
	StarterProjectCharacterHandoverDataUpdate.ApplyTo(StarterProjectCharacterHandoverData);
	...
	return improbable::unreal::FEntityBuilder::Begin()
		...
		.AddComponent<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterSingleClientRepData>(SingleClientStarterProjectCharacterData, WorkersOnly)
		.AddComponent<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterMultiClientRepData>(MultiClientStarterProjectCharacterData, WorkersOnly)
		.AddComponent<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterHandoverData>(StarterProjectCharacterHandoverData, WorkersOnly)
		.AddComponent<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs>(improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Data{}, OwningClientOnly)
		.AddComponent<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs>(improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Data{}, WorkersOnly)
		.AddComponent<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterNetMulticastRPCs>(improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterNetMulticastRPCs::Data{}, WorkersOnly)
		.Build();
}

void USpatialTypeBinding_StarterProjectCharacter::SendComponentUpdates(const FPropertyChangeState& Changes, USpatialActorChannel* Channel, const FEntityId& EntityId) const
{
	// Build SpatialOS updates.
	improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterSingleClientRepData::Update SingleClientUpdate;
	bool bSingleClientUpdateChanged = false;
	improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterMultiClientRepData::Update MultiClientUpdate;
	bool bMultiClientUpdateChanged = false;
	improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterHandoverData::Update HandoverDataUpdate;
	...
	{
		Connection->SendComponentUpdate<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterSingleClientRepData>(EntityId.ToSpatialEntityId(), SingleClientUpdate);
	}
	if (bMultiClientUpdateChanged)
	{
		Connection->SendComponentUpdate<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterMultiClientRepData>(EntityId.ToSpatialEntityId(), MultiClientUpdate);
	}
	if (bHandoverDataUpdateChanged)
	{
		Connection->SendComponentUpdate<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterHandoverData>(EntityId.ToSpatialEntityId(), HandoverDataUpdate);
	}
}

void USpatialTypeBinding_StarterProjectCharacter::SendRPCCommand(UObject* TargetObject, const UFunction* const Function, void* Parameters)
{
	TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
...
void USpatialTypeBinding_StarterProjectCharacter::ReceiveAddComponent(USpatialActorChannel* Channel, UAddComponentOpWrapperBase* AddComponentOp) const
{
	auto* SingleClientAddOp = Cast<UStarterProjectCharacterSingleClientRepDataAddComponentOp>(AddComponentOp);
	if (SingleClientAddOp)
	{
		auto Update = improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterSingleClientRepData::Update::FromInitialData(*SingleClientAddOp->Data.data());
		ReceiveUpdate_SingleClient(Channel, Update);
		return;
	}
	auto* MultiClientAddOp = Cast<UStarterProjectCharacterMultiClientRepDataAddComponentOp>(AddComponentOp);
	if (MultiClientAddOp)
	{
		auto Update = improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterMultiClientRepData::Update::FromInitialData(*MultiClientAddOp->Data.data());
		ReceiveUpdate_MultiClient(Channel, Update);
		return;
	}
	auto* HandoverDataAddOp = Cast<UStarterProjectCharacterHandoverDataAddComponentOp>(AddComponentOp);
	if (HandoverDataAddOp)
	{
		auto Update = improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterHandoverData::Update::FromInitialData(*HandoverDataAddOp->Data.data());
		ReceiveUpdate_Handover(Channel, Update);
		return;
	}
}

worker::Map<worker::ComponentId, worker::InterestOverride> USpatialTypeBinding_StarterProjectCharacter::GetInterestOverrideMap(bool bIsClient, bool bAutonomousProxy) const
{
	...
	if (bIsClient)
	{
		if (!bAutonomousProxy)
		{
			Interest.emplace(improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterSingleClientRepData::ComponentId, worker::InterestOverride{false});
		}
		Interest.emplace(improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterHandoverData::ComponentId, worker::InterestOverride{false});
	}
	return Interest;
}

void USpatialTypeBinding_StarterProjectCharacter::BuildSpatialComponentUpdate(
...
void USpatialTypeBinding_StarterProjectCharacter::ServerSendUpdate_SingleClient(const uint8* RESTRICT Data, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterSingleClientRepData::Update& OutUpdate) const
{
}

void USpatialTypeBinding_StarterProjectCharacter::ServerSendUpdate_MultiClient(const uint8* RESTRICT Data, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterMultiClientRepData::Update& OutUpdate) const
{
	switch (Handle)
	{
...
void USpatialTypeBinding_StarterProjectCharacter::ServerSendUpdate_Handover(const uint8* RESTRICT Data, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterHandoverData::Update& OutUpdate) const
{
	switch (Handle)
	{
...
void USpatialTypeBinding_StarterProjectCharacter::ReceiveUpdate_SingleClient(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterSingleClientRepData::Update& Update) const
{
...
void USpatialTypeBinding_StarterProjectCharacter::ReceiveUpdate_MultiClient(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterMultiClientRepData::Update& Update) const
{
	AActor* TargetObject = ActorChannel->Actor;
	ActorChannel->PreReceiveSpatialUpdate(TargetObject);
	...
	const bool bAutonomousProxy = ActorChannel->IsClientAutonomousProxy(improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::ComponentId);
...
void USpatialTypeBinding_StarterProjectCharacter::ReceiveUpdate_Handover(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterHandoverData::Update& Update) const
{
...
void USpatialTypeBinding_StarterProjectCharacter::ReceiveUpdate_NetMulticastRPCs(worker::EntityId EntityId, const improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterNetMulticastRPCs::Update& Update)
{
...
void USpatialTypeBinding_StarterProjectCharacter::TestClientRPC_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	auto Sender = [this, Connection, TargetObject]() mutable -> FRPCCommandRequestResult
	{
		...
		UE_LOG(LogSpatialGDKInterop, Verbose, TEXT("%s: Sending RPC: TestClientRPC, target: %s %s"),
			...
			*ObjectRefToString(TargetObjectRef));
			...
			auto RequestId = Connection->SendCommandRequest<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Testclientrpc>(TargetObjectRef.entity(), RPCPayload, 0);
			return {RequestId.Id};
	};
	Interop->InvokeRPCSendHandler_Internal(Sender, /*bReliable*/ true);
}
void USpatialTypeBinding_StarterProjectCharacter::RootMotionDebugClientPrintOnScreen_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	...
	auto Sender = [this, Connection, TargetObject, StructuredParams]() mutable -> FRPCCommandRequestResult
	{
		...
		UE_LOG(LogSpatialGDKInterop, Verbose, TEXT("%s: Sending RPC: RootMotionDebugClientPrintOnScreen, target: %s %s"),
			...
			*ObjectRefToString(TargetObjectRef));
			...
			auto RequestId = Connection->SendCommandRequest<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Rootmotiondebugclientprintonscreen>(TargetObjectRef.entity(), RPCPayload, 0);
			return {RequestId.Id};
	};
	Interop->InvokeRPCSendHandler_Internal(Sender, /*bReliable*/ true);
}
void USpatialTypeBinding_StarterProjectCharacter::ClientVeryShortAdjustPosition_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	// This struct is declared in Character.generated.h (in a macro that is then put in Character.h UCLASS macro)
	...
	auto Sender = [this, Connection, TargetObject, StructuredParams]() mutable -> FRPCCommandRequestResult
	{
		...
		UE_LOG(LogSpatialGDKInterop, Verbose, TEXT("%s: Sending RPC: ClientVeryShortAdjustPosition, target: %s %s"),
			...
			*ObjectRefToString(TargetObjectRef));
			...
			auto RequestId = Connection->SendCommandRequest<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientveryshortadjustposition>(TargetObjectRef.entity(), RPCPayload, 0);
			return {RequestId.Id};
	};
	Interop->InvokeRPCSendHandler_Internal(Sender, /*bReliable*/ false);
}
void USpatialTypeBinding_StarterProjectCharacter::ClientCheatWalk_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	auto Sender = [this, Connection, TargetObject]() mutable -> FRPCCommandRequestResult
	{
		// Resolve TargetObject.
		...
		UE_LOG(LogSpatialGDKInterop, Verbose, TEXT("%s: Sending RPC: ClientCheatWalk, target: %s %s"),
			...
			*ObjectRefToString(TargetObjectRef));
			...
			auto RequestId = Connection->SendCommandRequest<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientcheatwalk>(TargetObjectRef.entity(), RPCPayload, 0);
			return {RequestId.Id};
	};
	Interop->InvokeRPCSendHandler_Internal(Sender, /*bReliable*/ true);
}
void USpatialTypeBinding_StarterProjectCharacter::ClientCheatGhost_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	auto Sender = [this, Connection, TargetObject]() mutable -> FRPCCommandRequestResult
	{
		// Resolve TargetObject.
		...
		UE_LOG(LogSpatialGDKInterop, Verbose, TEXT("%s: Sending RPC: ClientCheatGhost, target: %s %s"),
			...
			*ObjectRefToString(TargetObjectRef));
			...
			auto RequestId = Connection->SendCommandRequest<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientcheatghost>(TargetObjectRef.entity(), RPCPayload, 0);
			return {RequestId.Id};
	};
	Interop->InvokeRPCSendHandler_Internal(Sender, /*bReliable*/ true);
}
void USpatialTypeBinding_StarterProjectCharacter::ClientCheatFly_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	auto Sender = [this, Connection, TargetObject]() mutable -> FRPCCommandRequestResult
	{
		// Resolve TargetObject.
		...
		UE_LOG(LogSpatialGDKInterop, Verbose, TEXT("%s: Sending RPC: ClientCheatFly, target: %s %s"),
			...
			*ObjectRefToString(TargetObjectRef));
			...
			auto RequestId = Connection->SendCommandRequest<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientcheatfly>(TargetObjectRef.entity(), RPCPayload, 0);
			return {RequestId.Id};
	};
	Interop->InvokeRPCSendHandler_Internal(Sender, /*bReliable*/ true);
}
void USpatialTypeBinding_StarterProjectCharacter::ClientAdjustRootMotionSourcePosition_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	// This struct is declared in Character.generated.h (in a macro that is then put in Character.h UCLASS macro)
	...
	auto Sender = [this, Connection, TargetObject, StructuredParams]() mutable -> FRPCCommandRequestResult
	{
		...
		UE_LOG(LogSpatialGDKInterop, Verbose, TEXT("%s: Sending RPC: ClientAdjustRootMotionSourcePosition, target: %s %s"),
			...
			*ObjectRefToString(TargetObjectRef));
			...
			auto RequestId = Connection->SendCommandRequest<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientadjustrootmotionsourceposition>(TargetObjectRef.entity(), RPCPayload, 0);
			return {RequestId.Id};
	};
	Interop->InvokeRPCSendHandler_Internal(Sender, /*bReliable*/ false);
}
void USpatialTypeBinding_StarterProjectCharacter::ClientAdjustRootMotionPosition_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	// This struct is declared in Character.generated.h (in a macro that is then put in Character.h UCLASS macro)
	...
	auto Sender = [this, Connection, TargetObject, StructuredParams]() mutable -> FRPCCommandRequestResult
	{
		...
		UE_LOG(LogSpatialGDKInterop, Verbose, TEXT("%s: Sending RPC: ClientAdjustRootMotionPosition, target: %s %s"),
			...
			*ObjectRefToString(TargetObjectRef));
			...
			auto RequestId = Connection->SendCommandRequest<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientadjustrootmotionposition>(TargetObjectRef.entity(), RPCPayload, 0);
			return {RequestId.Id};
	};
	Interop->InvokeRPCSendHandler_Internal(Sender, /*bReliable*/ false);
}
void USpatialTypeBinding_StarterProjectCharacter::ClientAdjustPosition_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	// This struct is declared in Character.generated.h (in a macro that is then put in Character.h UCLASS macro)
	...
	auto Sender = [this, Connection, TargetObject, StructuredParams]() mutable -> FRPCCommandRequestResult
	{
		...
		UE_LOG(LogSpatialGDKInterop, Verbose, TEXT("%s: Sending RPC: ClientAdjustPosition, target: %s %s"),
			...
			*ObjectRefToString(TargetObjectRef));
			...
			auto RequestId = Connection->SendCommandRequest<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientadjustposition>(TargetObjectRef.entity(), RPCPayload, 0);
			return {RequestId.Id};
	};
	Interop->InvokeRPCSendHandler_Internal(Sender, /*bReliable*/ false);
}
void USpatialTypeBinding_StarterProjectCharacter::ClientAckGoodMove_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	// This struct is declared in Character.generated.h (in a macro that is then put in Character.h UCLASS macro)
	...
	auto Sender = [this, Connection, TargetObject, StructuredParams]() mutable -> FRPCCommandRequestResult
	{
		...
		UE_LOG(LogSpatialGDKInterop, Verbose, TEXT("%s: Sending RPC: ClientAckGoodMove, target: %s %s"),
			...
			*ObjectRefToString(TargetObjectRef));
			...
			auto RequestId = Connection->SendCommandRequest<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientackgoodmove>(TargetObjectRef.entity(), RPCPayload, 0);
			return {RequestId.Id};
	};
	Interop->InvokeRPCSendHandler_Internal(Sender, /*bReliable*/ false);
}
void USpatialTypeBinding_StarterProjectCharacter::TestRPC_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	auto Sender = [this, Connection, TargetObject]() mutable -> FRPCCommandRequestResult
	{
		// Resolve TargetObject.
		...
		UE_LOG(LogSpatialGDKInterop, Verbose, TEXT("%s: Sending RPC: TestRPC, target: %s %s"),
			...
			*ObjectRefToString(TargetObjectRef));
			...
			auto RequestId = Connection->SendCommandRequest<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Testrpc>(TargetObjectRef.entity(), RPCPayload, 0);
			return {RequestId.Id};
	};
	Interop->InvokeRPCSendHandler_Internal(Sender, /*bReliable*/ true);
}
void USpatialTypeBinding_StarterProjectCharacter::ServerMoveOld_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	// This struct is declared in Character.generated.h (in a macro that is then put in Character.h UCLASS macro)
	...
	auto Sender = [this, Connection, TargetObject, StructuredParams]() mutable -> FRPCCommandRequestResult
	{
		...
		UE_LOG(LogSpatialGDKInterop, Verbose, TEXT("%s: Sending RPC: ServerMoveOld, target: %s %s"),
			...
			*ObjectRefToString(TargetObjectRef));
			...
			auto RequestId = Connection->SendCommandRequest<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermoveold>(TargetObjectRef.entity(), RPCPayload, 0);
			return {RequestId.Id};
	};
	Interop->InvokeRPCSendHandler_Internal(Sender, /*bReliable*/ false);
}
void USpatialTypeBinding_StarterProjectCharacter::ServerMoveNoBase_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	// This struct is declared in Character.generated.h (in a macro that is then put in Character.h UCLASS macro)
	...
	auto Sender = [this, Connection, TargetObject, StructuredParams]() mutable -> FRPCCommandRequestResult
	{
		...
		UE_LOG(LogSpatialGDKInterop, Verbose, TEXT("%s: Sending RPC: ServerMoveNoBase, target: %s %s"),
			...
			*ObjectRefToString(TargetObjectRef));
			...
			auto RequestId = Connection->SendCommandRequest<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermovenobase>(TargetObjectRef.entity(), RPCPayload, 0);
			return {RequestId.Id};
	};
	Interop->InvokeRPCSendHandler_Internal(Sender, /*bReliable*/ false);
}
void USpatialTypeBinding_StarterProjectCharacter::ServerMoveDualNoBase_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	// This struct is declared in Character.generated.h (in a macro that is then put in Character.h UCLASS macro)
	...
	auto Sender = [this, Connection, TargetObject, StructuredParams]() mutable -> FRPCCommandRequestResult
	{
		...
		UE_LOG(LogSpatialGDKInterop, Verbose, TEXT("%s: Sending RPC: ServerMoveDualNoBase, target: %s %s"),
			...
			*ObjectRefToString(TargetObjectRef));
			...
			auto RequestId = Connection->SendCommandRequest<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermovedualnobase>(TargetObjectRef.entity(), RPCPayload, 0);
			return {RequestId.Id};
	};
	Interop->InvokeRPCSendHandler_Internal(Sender, /*bReliable*/ false);
}
void USpatialTypeBinding_StarterProjectCharacter::ServerMoveDualHybridRootMotion_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	// This struct is declared in Character.generated.h (in a macro that is then put in Character.h UCLASS macro)
	...
	auto Sender = [this, Connection, TargetObject, StructuredParams]() mutable -> FRPCCommandRequestResult
	{
		...
		UE_LOG(LogSpatialGDKInterop, Verbose, TEXT("%s: Sending RPC: ServerMoveDualHybridRootMotion, target: %s %s"),
			...
			*ObjectRefToString(TargetObjectRef));
			...
			auto RequestId = Connection->SendCommandRequest<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermovedualhybridrootmotion>(TargetObjectRef.entity(), RPCPayload, 0);
			return {RequestId.Id};
	};
	Interop->InvokeRPCSendHandler_Internal(Sender, /*bReliable*/ false);
}
void USpatialTypeBinding_StarterProjectCharacter::ServerMoveDual_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	// This struct is declared in Character.generated.h (in a macro that is then put in Character.h UCLASS macro)
	...
	auto Sender = [this, Connection, TargetObject, StructuredParams]() mutable -> FRPCCommandRequestResult
	{
		...
		UE_LOG(LogSpatialGDKInterop, Verbose, TEXT("%s: Sending RPC: ServerMoveDual, target: %s %s"),
			...
			*ObjectRefToString(TargetObjectRef));
			...
			auto RequestId = Connection->SendCommandRequest<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermovedual>(TargetObjectRef.entity(), RPCPayload, 0);
			return {RequestId.Id};
	};
	Interop->InvokeRPCSendHandler_Internal(Sender, /*bReliable*/ false);
}
void USpatialTypeBinding_StarterProjectCharacter::ServerMove_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	// This struct is declared in Character.generated.h (in a macro that is then put in Character.h UCLASS macro)
	...
	auto Sender = [this, Connection, TargetObject, StructuredParams]() mutable -> FRPCCommandRequestResult
	{
		...
		UE_LOG(LogSpatialGDKInterop, Verbose, TEXT("%s: Sending RPC: ServerMove, target: %s %s"),
			...
			*ObjectRefToString(TargetObjectRef));
			...
			auto RequestId = Connection->SendCommandRequest<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermove>(TargetObjectRef.entity(), RPCPayload, 0);
			return {RequestId.Id};
	};
	Interop->InvokeRPCSendHandler_Internal(Sender, /*bReliable*/ false);
}
void USpatialTypeBinding_StarterProjectCharacter::TestMulticast_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	auto Sender = [this, Connection, TargetObject]() mutable -> FRPCCommandRequestResult
	{
		// Resolve TargetObject.
		...
		UE_LOG(LogSpatialGDKInterop, Verbose, TEXT("%s: Sending RPC: TestMulticast, target: %s %s"),
			...
			*ObjectRefToString(TargetObjectRef));
			...
			improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterNetMulticastRPCs::Update Update;
			...
			Connection->SendComponentUpdate<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterNetMulticastRPCs>(TargetObjectRef.entity(), Update);
			return {};
	};
	Interop->InvokeRPCSendHandler_Internal(Sender, /*bReliable*/ false);
}
void USpatialTypeBinding_StarterProjectCharacter::TestClientRPC_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Testclientrpc>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		...
		TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
		Connection->SendCommandResponse<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Testclientrpc>(Op.RequestId, {});
		return {};
	};
	Interop->InvokeRPCReceiveHandler_Internal(Receiver);
}
void USpatialTypeBinding_StarterProjectCharacter::RootMotionDebugClientPrintOnScreen_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Rootmotiondebugclientprintonscreen>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		improbable::unreal::UnrealObjectRef TargetObjectRef{Op.EntityId, Op.Request.target_subobject_offset(), {}, {}};
		...
		// Send command response.
		TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
		Connection->SendCommandResponse<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Rootmotiondebugclientprintonscreen>(Op.RequestId, {});
		return {};
	};
	Interop->InvokeRPCReceiveHandler_Internal(Receiver);
}
void USpatialTypeBinding_StarterProjectCharacter::ClientVeryShortAdjustPosition_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientveryshortadjustposition>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		improbable::unreal::UnrealObjectRef TargetObjectRef{Op.EntityId, Op.Request.target_subobject_offset(), {}, {}};
		...
		// Send command response.
		TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
		Connection->SendCommandResponse<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientveryshortadjustposition>(Op.RequestId, {});
		return {};
	};
	Interop->InvokeRPCReceiveHandler_Internal(Receiver);
}
void USpatialTypeBinding_StarterProjectCharacter::ClientCheatWalk_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientcheatwalk>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		improbable::unreal::UnrealObjectRef TargetObjectRef{Op.EntityId, Op.Request.target_subobject_offset(), {}, {}};
		...
		// Send command response.
		TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
		Connection->SendCommandResponse<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientcheatwalk>(Op.RequestId, {});
		return {};
	};
	Interop->InvokeRPCReceiveHandler_Internal(Receiver);
}
void USpatialTypeBinding_StarterProjectCharacter::ClientCheatGhost_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientcheatghost>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		improbable::unreal::UnrealObjectRef TargetObjectRef{Op.EntityId, Op.Request.target_subobject_offset(), {}, {}};
		...
		// Send command response.
		TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
		Connection->SendCommandResponse<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientcheatghost>(Op.RequestId, {});
		return {};
	};
	Interop->InvokeRPCReceiveHandler_Internal(Receiver);
}
void USpatialTypeBinding_StarterProjectCharacter::ClientCheatFly_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientcheatfly>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		improbable::unreal::UnrealObjectRef TargetObjectRef{Op.EntityId, Op.Request.target_subobject_offset(), {}, {}};
		...
		// Send command response.
		TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
		Connection->SendCommandResponse<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientcheatfly>(Op.RequestId, {});
		return {};
	};
	Interop->InvokeRPCReceiveHandler_Internal(Receiver);
}
void USpatialTypeBinding_StarterProjectCharacter::ClientAdjustRootMotionSourcePosition_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientadjustrootmotionsourceposition>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		improbable::unreal::UnrealObjectRef TargetObjectRef{Op.EntityId, Op.Request.target_subobject_offset(), {}, {}};
		...
		// Send command response.
		TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
		Connection->SendCommandResponse<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientadjustrootmotionsourceposition>(Op.RequestId, {});
		return {};
	};
	Interop->InvokeRPCReceiveHandler_Internal(Receiver);
}
void USpatialTypeBinding_StarterProjectCharacter::ClientAdjustRootMotionPosition_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientadjustrootmotionposition>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		improbable::unreal::UnrealObjectRef TargetObjectRef{Op.EntityId, Op.Request.target_subobject_offset(), {}, {}};
		...
		// Send command response.
		TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
		Connection->SendCommandResponse<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientadjustrootmotionposition>(Op.RequestId, {});
		return {};
	};
	Interop->InvokeRPCReceiveHandler_Internal(Receiver);
}
void USpatialTypeBinding_StarterProjectCharacter::ClientAdjustPosition_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientadjustposition>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		improbable::unreal::UnrealObjectRef TargetObjectRef{Op.EntityId, Op.Request.target_subobject_offset(), {}, {}};
		...
		// Send command response.
		TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
		Connection->SendCommandResponse<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientadjustposition>(Op.RequestId, {});
		return {};
	};
	Interop->InvokeRPCReceiveHandler_Internal(Receiver);
}
void USpatialTypeBinding_StarterProjectCharacter::ClientAckGoodMove_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientackgoodmove>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		improbable::unreal::UnrealObjectRef TargetObjectRef{Op.EntityId, Op.Request.target_subobject_offset(), {}, {}};
		...
		// Send command response.
		TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
		Connection->SendCommandResponse<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientackgoodmove>(Op.RequestId, {});
		return {};
	};
	Interop->InvokeRPCReceiveHandler_Internal(Receiver);
}
void USpatialTypeBinding_StarterProjectCharacter::TestRPC_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Testrpc>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		improbable::unreal::UnrealObjectRef TargetObjectRef{Op.EntityId, Op.Request.target_subobject_offset(), {}, {}};
		...
		// Send command response.
		TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
		Connection->SendCommandResponse<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Testrpc>(Op.RequestId, {});
		return {};
	};
	Interop->InvokeRPCReceiveHandler_Internal(Receiver);
}
void USpatialTypeBinding_StarterProjectCharacter::ServerMoveOld_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermoveold>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		improbable::unreal::UnrealObjectRef TargetObjectRef{Op.EntityId, Op.Request.target_subobject_offset(), {}, {}};
		...
		// Send command response.
		TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
		Connection->SendCommandResponse<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermoveold>(Op.RequestId, {});
		return {};
	};
	Interop->InvokeRPCReceiveHandler_Internal(Receiver);
}
void USpatialTypeBinding_StarterProjectCharacter::ServerMoveNoBase_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermovenobase>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		improbable::unreal::UnrealObjectRef TargetObjectRef{Op.EntityId, Op.Request.target_subobject_offset(), {}, {}};
		...
		// Send command response.
		TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
		Connection->SendCommandResponse<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermovenobase>(Op.RequestId, {});
		return {};
	};
	Interop->InvokeRPCReceiveHandler_Internal(Receiver);
}
void USpatialTypeBinding_StarterProjectCharacter::ServerMoveDualNoBase_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermovedualnobase>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		improbable::unreal::UnrealObjectRef TargetObjectRef{Op.EntityId, Op.Request.target_subobject_offset(), {}, {}};
		...
		// Send command response.
		TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
		Connection->SendCommandResponse<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermovedualnobase>(Op.RequestId, {});
		return {};
	};
	Interop->InvokeRPCReceiveHandler_Internal(Receiver);
}
void USpatialTypeBinding_StarterProjectCharacter::ServerMoveDualHybridRootMotion_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermovedualhybridrootmotion>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		improbable::unreal::UnrealObjectRef TargetObjectRef{Op.EntityId, Op.Request.target_subobject_offset(), {}, {}};
		...
		// Send command response.
		TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
		Connection->SendCommandResponse<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermovedualhybridrootmotion>(Op.RequestId, {});
		return {};
	};
	Interop->InvokeRPCReceiveHandler_Internal(Receiver);
}
void USpatialTypeBinding_StarterProjectCharacter::ServerMoveDual_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermovedual>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		improbable::unreal::UnrealObjectRef TargetObjectRef{Op.EntityId, Op.Request.target_subobject_offset(), {}, {}};
		...
		// Send command response.
		TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
		Connection->SendCommandResponse<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermovedual>(Op.RequestId, {});
		return {};
	};
	Interop->InvokeRPCReceiveHandler_Internal(Receiver);
}
void USpatialTypeBinding_StarterProjectCharacter::ServerMove_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermove>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		improbable::unreal::UnrealObjectRef TargetObjectRef{Op.EntityId, Op.Request.target_subobject_offset(), {}, {}};
		...
		// Send command response.
		TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
		Connection->SendCommandResponse<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermove>(Op.RequestId, {});
		return {};
	};
	Interop->InvokeRPCReceiveHandler_Internal(Receiver);
}
void USpatialTypeBinding_StarterProjectCharacter::TestMulticast_OnRPCPayload(const worker::EntityId EntityId, const improbable::unreal::generated::starterprojectcharacter::TestMulticastRequest& EventData)
{
...
void USpatialTypeBinding_StarterProjectCharacter::TestClientRPC_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Testclientrpc>& Op)
{
...
void USpatialTypeBinding_StarterProjectCharacter::RootMotionDebugClientPrintOnScreen_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Rootmotiondebugclientprintonscreen>& Op)
{
...
void USpatialTypeBinding_StarterProjectCharacter::ClientVeryShortAdjustPosition_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientveryshortadjustposition>& Op)
{
...
void USpatialTypeBinding_StarterProjectCharacter::ClientCheatWalk_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientcheatwalk>& Op)
{
...
void USpatialTypeBinding_StarterProjectCharacter::ClientCheatGhost_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientcheatghost>& Op)
{
...
void USpatialTypeBinding_StarterProjectCharacter::ClientCheatFly_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientcheatfly>& Op)
{
...
void USpatialTypeBinding_StarterProjectCharacter::ClientAdjustRootMotionSourcePosition_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientadjustrootmotionsourceposition>& Op)
{
...
void USpatialTypeBinding_StarterProjectCharacter::ClientAdjustRootMotionPosition_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientadjustrootmotionposition>& Op)
{
...
void USpatialTypeBinding_StarterProjectCharacter::ClientAdjustPosition_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientadjustposition>& Op)
{
...
void USpatialTypeBinding_StarterProjectCharacter::ClientAckGoodMove_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterClientRPCs::Commands::Clientackgoodmove>& Op)
{
...
void USpatialTypeBinding_StarterProjectCharacter::TestRPC_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Testrpc>& Op)
{
...
void USpatialTypeBinding_StarterProjectCharacter::ServerMoveOld_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermoveold>& Op)
{
...
void USpatialTypeBinding_StarterProjectCharacter::ServerMoveNoBase_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermovenobase>& Op)
{
...
void USpatialTypeBinding_StarterProjectCharacter::ServerMoveDualNoBase_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermovedualnobase>& Op)
{
...
void USpatialTypeBinding_StarterProjectCharacter::ServerMoveDualHybridRootMotion_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermovedualhybridrootmotion>& Op)
{
...
void USpatialTypeBinding_StarterProjectCharacter::ServerMoveDual_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermovedual>& Op)
{
...
void USpatialTypeBinding_StarterProjectCharacter::ServerMove_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::starterprojectcharacter::StarterProjectCharacterServerRPCs::Commands::Servermove>& Op)
{
