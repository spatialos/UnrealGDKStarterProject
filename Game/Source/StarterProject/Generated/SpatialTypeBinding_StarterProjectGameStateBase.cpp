...
#include "SpatialTypeBinding_StarterProjectGameStateBase.h"
...
#include "StarterProjectGameStateBaseSingleClientRepDataAddComponentOp.h"
#include "StarterProjectGameStateBaseMultiClientRepDataAddComponentOp.h"
#include "StarterProjectGameStateBaseHandoverDataAddComponentOp.h"

const FRepHandlePropertyMap& USpatialTypeBinding_StarterProjectGameStateBase::GetRepHandlePropertyMap() const
{
	return RepHandleToPropertyMap;
}

const FHandoverHandlePropertyMap& USpatialTypeBinding_StarterProjectGameStateBase::GetHandoverHandlePropertyMap() const
{
	return HandoverHandleToPropertyMap;
}

UClass* USpatialTypeBinding_StarterProjectGameStateBase::GetBoundClass() const
{
	return AStarterProjectGameStateBase::StaticClass();
}

void USpatialTypeBinding_StarterProjectGameStateBase::Init(USpatialInterop* InInterop, USpatialPackageMapClient* InPackageMap)
{
	Super::Init(InInterop, InPackageMap);


	UClass* Class = FindObject<UClass>(ANY_PACKAGE, TEXT("StarterProjectGameStateBase"));
...
void USpatialTypeBinding_StarterProjectGameStateBase::BindToView(bool bIsClient)
{
	...
	{
		ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseSingleClientRepData>([this](
			const worker::ComponentUpdateOp<improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseSingleClientRepData>& Op)
		{
			// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
			if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseSingleClientRepData::ComponentId))
			{
				return;
			}
		...
		ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseMultiClientRepData>([this](
			const worker::ComponentUpdateOp<improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseMultiClientRepData>& Op)
		{
			// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
			if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseMultiClientRepData::ComponentId))
			{
				return;
			}
			USpatialActorChannel* ActorChannel = Interop->GetActorChannelByEntityId(Op.EntityId);
		...
		if (!bIsClient)
		{
			ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseHandoverData>([this](
				const worker::ComponentUpdateOp<improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseHandoverData>& Op)
			{
				// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
				if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseHandoverData::ComponentId))
				{
					return;
				}
				USpatialActorChannel* ActorChannel = Interop->GetActorChannelByEntityId(Op.EntityId);
	...
	ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseNetMulticastRPCs>([this](
		const worker::ComponentUpdateOp<improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseNetMulticastRPCs>& Op)
	{
		// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
		if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseNetMulticastRPCs::ComponentId))
		{
			return;
		}
...
void USpatialTypeBinding_StarterProjectGameStateBase::UnbindFromView()
{
	ViewCallbacks.Reset();
}

worker::Entity USpatialTypeBinding_StarterProjectGameStateBase::CreateActorEntity(const FString& ClientWorkerId, const FVector& Position, const FString& Metadata, const FPropertyChangeState& InitialChanges, USpatialActorChannel* Channel) const
{
	...
	improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseSingleClientRepData::Data SingleClientStarterProjectGameStateBaseData;
	improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseSingleClientRepData::Update SingleClientStarterProjectGameStateBaseUpdate;
	bool bSingleClientStarterProjectGameStateBaseUpdateChanged = false;
	improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseMultiClientRepData::Data MultiClientStarterProjectGameStateBaseData;
	improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseMultiClientRepData::Update MultiClientStarterProjectGameStateBaseUpdate;
	bool bMultiClientStarterProjectGameStateBaseUpdateChanged = false;
	improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseHandoverData::Data StarterProjectGameStateBaseHandoverData;
	improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseHandoverData::Update StarterProjectGameStateBaseHandoverDataUpdate;
	bool bStarterProjectGameStateBaseHandoverDataUpdateChanged = false;

	BuildSpatialComponentUpdate(InitialChanges, Channel, SingleClientStarterProjectGameStateBaseUpdate, bSingleClientStarterProjectGameStateBaseUpdateChanged, MultiClientStarterProjectGameStateBaseUpdate, bMultiClientStarterProjectGameStateBaseUpdateChanged, StarterProjectGameStateBaseHandoverDataUpdate, bStarterProjectGameStateBaseHandoverDataUpdateChanged);
	SingleClientStarterProjectGameStateBaseUpdate.ApplyTo(SingleClientStarterProjectGameStateBaseData);
	MultiClientStarterProjectGameStateBaseUpdate.ApplyTo(MultiClientStarterProjectGameStateBaseData);
	StarterProjectGameStateBaseHandoverDataUpdate.ApplyTo(StarterProjectGameStateBaseHandoverData);
	...
	return improbable::unreal::FEntityBuilder::Begin()
		...
		.AddComponent<improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseSingleClientRepData>(SingleClientStarterProjectGameStateBaseData, WorkersOnly)
		.AddComponent<improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseMultiClientRepData>(MultiClientStarterProjectGameStateBaseData, WorkersOnly)
		.AddComponent<improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseHandoverData>(StarterProjectGameStateBaseHandoverData, WorkersOnly)
		.AddComponent<improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseClientRPCs>(improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseClientRPCs::Data{}, OwningClientOnly)
		.AddComponent<improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseServerRPCs>(improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseServerRPCs::Data{}, WorkersOnly)
		.AddComponent<improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseNetMulticastRPCs>(improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseNetMulticastRPCs::Data{}, WorkersOnly)
		.Build();
}

void USpatialTypeBinding_StarterProjectGameStateBase::SendComponentUpdates(const FPropertyChangeState& Changes, USpatialActorChannel* Channel, const FEntityId& EntityId) const
{
	...
	{
		Connection->SendComponentUpdate<improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseSingleClientRepData>(EntityId.ToSpatialEntityId(), SingleClientUpdate);
	}
	if (bMultiClientUpdateChanged)
	{
		Connection->SendComponentUpdate<improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseMultiClientRepData>(EntityId.ToSpatialEntityId(), MultiClientUpdate);
	}
	if (bHandoverDataUpdateChanged)
	{
		Connection->SendComponentUpdate<improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseHandoverData>(EntityId.ToSpatialEntityId(), HandoverDataUpdate);
	}
}

void USpatialTypeBinding_StarterProjectGameStateBase::SendRPCCommand(UObject* TargetObject, const UFunction* const Function, void* Parameters)
{
	TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
...
void USpatialTypeBinding_StarterProjectGameStateBase::ReceiveAddComponent(USpatialActorChannel* Channel, UAddComponentOpWrapperBase* AddComponentOp) const
{
	auto* SingleClientAddOp = Cast<UStarterProjectGameStateBaseSingleClientRepDataAddComponentOp>(AddComponentOp);
	if (SingleClientAddOp)
	{
		auto Update = improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseSingleClientRepData::Update::FromInitialData(*SingleClientAddOp->Data.data());
		ReceiveUpdate_SingleClient(Channel, Update);
		return;
	}
	auto* MultiClientAddOp = Cast<UStarterProjectGameStateBaseMultiClientRepDataAddComponentOp>(AddComponentOp);
	if (MultiClientAddOp)
	{
		auto Update = improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseMultiClientRepData::Update::FromInitialData(*MultiClientAddOp->Data.data());
		ReceiveUpdate_MultiClient(Channel, Update);
		return;
	}
	auto* HandoverDataAddOp = Cast<UStarterProjectGameStateBaseHandoverDataAddComponentOp>(AddComponentOp);
	if (HandoverDataAddOp)
	{
		auto Update = improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseHandoverData::Update::FromInitialData(*HandoverDataAddOp->Data.data());
		ReceiveUpdate_Handover(Channel, Update);
		return;
	}
}

worker::Map<worker::ComponentId, worker::InterestOverride> USpatialTypeBinding_StarterProjectGameStateBase::GetInterestOverrideMap(bool bIsClient, bool bAutonomousProxy) const
{
	...
	if (bIsClient)
	{
		if (!bAutonomousProxy)
		{
			Interest.emplace(improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseSingleClientRepData::ComponentId, worker::InterestOverride{false});
		}
		Interest.emplace(improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseHandoverData::ComponentId, worker::InterestOverride{false});
	}
	return Interest;
}

void USpatialTypeBinding_StarterProjectGameStateBase::BuildSpatialComponentUpdate(
...
void USpatialTypeBinding_StarterProjectGameStateBase::ServerSendUpdate_SingleClient(const uint8* RESTRICT Data, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseSingleClientRepData::Update& OutUpdate) const
{
}

void USpatialTypeBinding_StarterProjectGameStateBase::ServerSendUpdate_MultiClient(const uint8* RESTRICT Data, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseMultiClientRepData::Update& OutUpdate) const
{
	switch (Handle)
	{
...
void USpatialTypeBinding_StarterProjectGameStateBase::ServerSendUpdate_Handover(const uint8* RESTRICT Data, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseHandoverData::Update& OutUpdate) const
{
}

void USpatialTypeBinding_StarterProjectGameStateBase::ReceiveUpdate_SingleClient(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseSingleClientRepData::Update& Update) const
{
...
void USpatialTypeBinding_StarterProjectGameStateBase::ReceiveUpdate_MultiClient(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseMultiClientRepData::Update& Update) const
{
	AActor* TargetObject = ActorChannel->Actor;
	ActorChannel->PreReceiveSpatialUpdate(TargetObject);
	...
	const bool bAutonomousProxy = ActorChannel->IsClientAutonomousProxy(improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseClientRPCs::ComponentId);
...
void USpatialTypeBinding_StarterProjectGameStateBase::ReceiveUpdate_Handover(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseHandoverData::Update& Update) const
{
}

void USpatialTypeBinding_StarterProjectGameStateBase::ReceiveUpdate_NetMulticastRPCs(worker::EntityId EntityId, const improbable::unreal::generated::starterprojectgamestatebase::StarterProjectGameStateBaseNetMulticastRPCs::Update& Update)
{
}
